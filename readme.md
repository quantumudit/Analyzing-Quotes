...
<h4 align="center">Scraping & Analyzing Quotes from <a href="https://quotes.toscrape.com/" target="_blank">Quotes to Scrape</a> website with <a href="https://en.wikipedia.org/wiki/Python_(programming_language)" target="_blank">Python</a> and <a href="https://en.wikipedia.org/wiki/Microsoft_Power_BI" target="_blank">Power BI</a></h4>
...
This project focuses on scraping quotes and their associated attributes from [Quotes to Scrape](https://quotes.toscrape.com/), performing exploratory data analysis to generate insights and visualize them with the help of Power BI.
